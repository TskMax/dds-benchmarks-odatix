...
# Execution command: python3 publi_ExcessFour.py

# ==========================================
# 1. SCRIPT PARAMETERS
# ==========================================
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
DEFAULT_ARCHITECTURE = 'Publi_ExcessFour'  

# FORCE YOUR OWN DISPLAY NAME HERE FOR THE PUBLICATION TITLE
DISPLAY_NAME = "Excess Four"  
...
def load_data(file_path):
    ...
    # Target configurations by letters
    allowed_configs = {'A', 'B', 'C', 'D', 'E', 'F', 'G'}
    # MODIFICATION: Matching the exact key from your new dataset
    target_key = 'Madisetti_reconfigurable'
    
    for techno, archs in fmax_results.items():
        if target_key not in archs:
            continue
            
        bits_dict = archs[target_key]
    ...
    # Categorical sorting from A to G
...
def plot_combined_figure(df, area_unit, fmax_unit, power_unit, output_dir, arch_name, display_name):
    ...
    color2 = 'tab:red'
    ax3.set_xlabel('Configuration Case', fontweight='bold')

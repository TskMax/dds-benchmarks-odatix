...
# Execution command: python3 publi_Tierney_EightWave_R4.py

# ==========================================
# 1. SCRIPT PARAMETERS
# ==========================================
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
# MODIFICATION : Nom du dossier par défaut mis à jour pour ta nouvelle architecture EightR4
DEFAULT_ARCHITECTURE = 'Publi_Tierney_EightWave_R4'  

# FORCE YOUR OWN DISPLAY NAME HERE FOR THE PUBLICATION TITLE
DISPLAY_NAME = "Tierney Eighth-Wave R4"  
...
def load_data(file_path):
    ...
    # MODIFICATION : Liste des configurations autorisées mise à jour pour le fichier EightR4
    allowed_configs = {'3334', '3343', '3433', '4333'}
    ...
    for techno, archs in fmax_results.items():
        for arch, bits_dict in archs.items():
            for bit_str, metrics in bits_dict.items():
                ...
                # Filtrage strict sur les clés de partitionnement de ton nouveau fichier
    ...
    # MODIFICATION : Tri catégoriel adapté à l'ordre exact de tes nouvelles configurations
    custom_order = ['3334', '3343', '3433', '4333']
...
def plot_combined_figure(df, area_unit, fmax_unit, power_unit, output_dir, arch_name, display_name):
    ...
    ax3.tick_params(axis='x', rotation=0) # Pas de rotation nécessaire pour 4 labels courts

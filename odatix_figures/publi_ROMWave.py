...
# Execution command: python3 publi_ROMWave.py

# ==========================================
# 1. SCRIPT PARAMETERS
# ==========================================
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
DEFAULT_ARCHITECTURE = 'Publi_QuarterWave_V2'  # Folder name (e.g., FullWave, QuarterWave)

# FORCE YOUR OWN DISPLAY NAME HERE FOR THE PUBLICATION TITLE
DISPLAY_NAME = "Quarter-Wave"  # Customize this string as you wish!
...
def plot_combined_figure(df, area_unit, fmax_unit, power_unit, output_dir, arch_name, display_name):
    ...
    # MODIFICATION: Added figure label 'A'
    ...
    # MODIFICATION: Swapped Fmax for Total Power on this axis
    ax2 = ax1.twinx()
    color3 = 'tab:green'
    ...
    # --- BOTTOM SUBPLOT: Fmax ---
    # MODIFICATION: Added figure label 'B'
    ax3.set_title("(b)", loc='left', fontweight='bold', fontsize=16)
    
    # MODIFICATION: Swapped Total Power for Fmax on this axis
    color2 = 'tab:red'
    ax3.set_xlabel('Phase Bus Width (Bits)', fontweight='bold')
    ...
    # Force the X-axis to display only present integers on the bottom plot (shared with top)
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help='Name of the architecture folder (e.g., FullWave, QuarterWave).'
    )

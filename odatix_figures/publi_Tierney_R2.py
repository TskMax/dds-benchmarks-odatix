...
# Execution command: python3 publi_Tierney_R2.py

# ==========================================
# 1. SCRIPT PARAMETERS
# ==========================================
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
# MODIFICATION: Updated default folder to match your new architecture
DEFAULT_ARCHITECTURE = 'Publi_Tierney_EightWave_R2'  # Folder name (e.g., FullWave, QuarterWave)

# FORCE YOUR OWN DISPLAY NAME HERE FOR THE PUBLICATION TITLE
DISPLAY_NAME = "Tierney Eighth-Wave R2"  # Customize this string as you wish!
    ...
    for techno, archs in fmax_results.items():
        for arch, bits_dict in archs.items():
            for bit_str, metrics in bits_dict.items():
                ...
                # MODIFICATION: robust string replacement for both 'Bits' and 'lsb'
                bit_val = int(bit_str.replace('Bits', '').replace('lsb', ''))

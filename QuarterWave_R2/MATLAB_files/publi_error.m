...
try
    y_chisel = load('cos_dds_output_odatix.txt'); 
catch
    error('File cos_dds_output_odatix.txt not found or badly formatted.');
end
y_chisel = y_chisel(:); 
...
drawnow;
exportgraphics(gcf, 'spectral_analysis_chisel_Quarter_R2.pdf', 'ContentType', 'vector');